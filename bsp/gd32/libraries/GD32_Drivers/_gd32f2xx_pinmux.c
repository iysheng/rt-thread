...
static struct _gd32_pinmux_map gs_gd32f2xx_map = {
     ...
     * 8 9 a b
     * c d e f */
    {{{PINMUX_DEFAULT, GPIO_MODE_OUT_PP, GPIO_MODE_AF_PP, GPIO_MODE_AF_PP,
     PINMUX_DEFAULT, GPIO_MODE_AF_PP, GPIO_MODE_AF_PP, GPIO_MODE_AF_PP,
     GPIO_MODE_AF_PP, GPIO_MODE_AF_PP, GPIO_MODE_IN_FLOATING, GPIO_MODE_IPU,
     GPIO_MODE_AF_PP, PINMUX_DEFAULT, PINMUX_DEFAULT, PINMUX_DEFAULT},
     GPIOA, RCU_GPIOA}, /* GPIOA */
    {{GPIO_MODE_IPD, GPIO_MODE_IPD, GPIO_MODE_IPD, GPIO_MODE_IPD,
     GPIO_MODE_AF_PP, GPIO_MODE_OUT_PP, GPIO_MODE_AF_PP, GPIO_MODE_IPD,
     GPIO_MODE_IPD, GPIO_MODE_IPD, GPIO_MODE_IPD, GPIO_MODE_IPD,
     PINMUX_DEFAULT, GPIO_MODE_AF_PP, GPIO_MODE_AF_PP, GPIO_MODE_OUT_PP},
     GPIOB, RCU_GPIOB}, /* GPIOB */
    {{GPIO_MODE_IPD, GPIO_MODE_IPD, GPIO_MODE_OUT_PP, GPIO_MODE_OUT_PP,
     GPIO_MODE_IPD, GPIO_MODE_IPD, PINMUX_DEFAULT, PINMUX_DEFAULT,
     PINMUX_DEFAULT, GPIO_MODE_AF_PP, GPIO_MODE_IPD, GPIO_MODE_IPD,
...
static remap_set_t gs_remap_sets[] = {
    ...
    {GPIO_TIMER1_PARTIAL_REMAP1, ENABLE},
};
